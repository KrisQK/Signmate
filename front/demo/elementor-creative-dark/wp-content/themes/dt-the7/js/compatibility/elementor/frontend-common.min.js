! function(e) {
    e(window).on("elementor/frontend/init", (function() {
        ...
        }, The7ElementorAnimation.prototype.findAnimationsInNode = function(t, n) {
            let i = "";
            void 0 !== n && (i = `:not(.${n})`);
            let o = t.find(`.elementor-element${i}`),
                s = [];
            return o.each((function() {
                const t = e(this),
                    n = new The7ElementorSettings(t),
                    i = n.getCurrentDeviceSetting("the7_animation") || n.getCurrentDeviceSetting("the7__animation");
                if (!i) return;
                const o = n.getSettings(),
                    r = o._animation_delay || o.animation_delay || 0;
                s.push({
                    $element: t,
                    animation: i,
                    animationDelay: r
    ...
    }, The7ElementorAnimation.patchElementsAnimation = function(t, n = "") {
        t.find(".elementor-element").each((function() {
            const t = e(this);
            if (!t.hasClass("the7-animate")) {
                let i = t.data("settings");
                if (void 0 !== i && Object.keys(i).length) {
                    let t = The7ElementorSettings.getResponsiveSettingList("animation"),
                        o = The7ElementorSettings.getResponsiveSettingList("_animation");
                    const s = t.concat(o);
                    let r = !1;
                    if (s.forEach((function(e) {
                            var t, n, o;
                            t = i, (n = e) !== (o = `the7_${e}`) && t[n] && (Object.defineProperty(t, o, Object.getOwnPropertyDescriptor(t, n)), delete t[n], 1) && (i[e] = "none", r = !0)
                        })), r) {
                        const t = e(this),
                            o = new The7ElementorSettings(t);
                        (o.getCurrentDeviceSetting("animation") || o.getCurrentDeviceSetting("_animation")) && t.addClass(`the7-hidden the7-animate ${n}`), t.attr("data-settings", JSON.stringify(i))
                    }
                }
            }
        }))
